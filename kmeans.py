...
ImageNames = ["2apples.jpg", "2or4objects.jpg", "7apples.jpg"]
No = 0
Image = cv2.imread(ImageNames[No])
Image = cv2.resize(Image, None, fx=0.5, fy=0.5)
print("Image Size:", Image.shape)

KMeans3D(Image, k=4, max_iterations=10, imgNameOut="img_out_3d.png")
KMeans5D(Image, k=4, max_iterations=10, imgNameOut="img_out_5d.png")
=======
import numpy as np
import cv2
import sys
